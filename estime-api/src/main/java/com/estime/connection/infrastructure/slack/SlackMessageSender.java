package com.estime.connection.infrastructure.slack;
...
import com.estime.connection.application.slack.util.SlackMessageBuilder;
import com.estime.connection.config.slack.SlackBotProperties;
