...
const sampleStatistics = new Map<string, DateCellInfo>([
  ['2024-01-15T10:00', { weight: 0.5, participantNames: ['마빈', '메이토', '강산', '해삐'] }],
  [
    '2024-01-15T10:30',
    { weight: 0.75, participantNames: ['마빈', '메이토', '강산', '해삐', '제프리', '리버'] },
  ],
  [
    '2024-01-15T14:00',
    {
  ...
  ['2024-01-17T15:00', { weight: 0.5, participantNames: ['마빈', '메이토', '강산', '해삐'] }],
]);
