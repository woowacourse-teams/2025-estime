...
public class DateTimeSlot implements Comparable<DateTimeSlot> {
    ...
    public static DateTimeSlot from(final LocalDateTime startAt) {
        ...
        final int timeSlotIndex = (startAt.getHour() * 60 + startAt.getMinute()) / (int) UNIT.toMinutes();
        return new DateTimeSlot((int) ((dayOffset << 8) | timeSlotIndex));
    }
    ...
    public LocalTime getStartAtLocalTime() {
        ...
        final int totalMinutes = timeSlotIndex * (int) UNIT.toMinutes();
        return LocalTime.of(totalMinutes / 60, totalMinutes % 60);
    }

    public LocalDateTime toLocalDateTime() {
        return LocalDateTime.of(getStartAtLocalDate(), getStartAtLocalTime());
    }
